...
def updatePlot(i, x, R):
    uav_plot.draw_at(ax, x[:, i], R[:, :, i])
...
# Run the simulation
anim = animation.FuncAnimation(fig, updatePlot, frames=steps, \
    fargs=(x, R,))

anim.save("media/example_uav.gif")